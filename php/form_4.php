...
if (!empty($_POST)){
   ...
   $fname_4 = htmlspecialchars($_POST["fname_4"]);     
   $phone_4 = htmlspecialchars($_POST["phone_4"]);  
...
{
  $subject = '=?utf-8?B?'.base64_encode('Заявка Форма 4 Получите и протестируйте образец абсолютно бесплатно!').'?=';
  $boundary = "--".md5(uniqid(time())); // генерируем разделитель
  
  $headers = "From:".htmlspecialchars($_POST["fname_4"])." <".htmlspecialchars($_POST["email_4"]).">\r\n"; 
